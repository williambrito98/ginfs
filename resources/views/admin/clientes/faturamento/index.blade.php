        ...
        <form action={{ route('faturamento.store') }} method="POST">
            ...
            <div id="tabela-faturamento" style="display:block">
                <x-table>
                    <x-slot name="columns">
                        <tr>
                            <th class="py-2 w-1/4 color-header-table">mês</th>
                            <th class="py-2 w-1/4 color-header-table">faturamento externo</th>
                            <th class="py-2 w-1/4 color-header-table">emissões pelo sistema</th>
                            <th class="py-2 w-1/4 color-header-table">total</th>
                        </tr>
                    </x-slot>
                    ...
                    <x-slot name="content">
                        <tr>
                            ...
                            <td>R$ <input type="text" name="totalFatExterno12" class="bg-grey-darker border-0 rounded text-center form-control"
                        ...
                        <tr>
                            ...
                            <td>R$ <input type="text" name="totalFatExterno11" class="bg-grey-darker border-0 rounded text-center form-control"
                        ...
                        <tr>
                            ...
                            <td>R$ <input type="text" name="totalFatExterno10" class=" bg-grey-darker border-0 rounded text-center form-control"
                        ...
                        <tr>
                            ...
                            <td>R$ <input type="text" name="totalFatExterno9" class="bg-grey-darker border-0 rounded text-center form-control"
                        ...
                        <tr>
                            ...
                            <td>R$ <input type="text" name="totalFatExterno8" class="bg-grey-darker border-0 rounded text-center form-control"
                        ...
                        <tr>
                            ...
                            <td>R$ <input type="text" name="totalFatExterno7" class="bg-grey-darker border-0 rounded text-center form-control"
                        ...
                        <tr>
                            ...
                            <td>R$ <input type="text" name="totalFatExterno6" class="bg-grey-darker border-0 rounded text-center form-control"
                        ...
                        <tr>
                            ...
                            <td>R$ <input type="text" name="totalFatExterno5" class="bg-grey-darker border-0 rounded text-center form-control"
                        ...
                        <tr>
                            ...
                            <td>R$ <input type="text" name="totalFatExterno4" class="bg-grey-darker border-0 rounded text-center form-control"
                        ...
                        <tr>
                            ...
                            <td>R$ <input type="text" name="totalFatExterno3" class="bg-grey-darker border-0 rounded text-center form-control"
                        ...
                        <tr>
                            ...
                            <td>R$ <input type="text" name="totalFatExterno2" class="bg-grey-darker border-0 rounded text-center form-control"
                        ...
                        <tr>
                            ...
                            <td>R$ <input type="text" name="totalFatExterno1" class="bg-grey-darker border-0 rounded text-center form-control"
                ...
                <div class="absolute top-11 right-0">
                    <button type="submit" class="flex items-center">
                        <div class="save-text text-2xl inline-block">Salvar</div>
                        <div class="inline-block ml-2"><x-svg.save /></div>
                    </button>
                </div>
            </div>
        </form>
                ...
                if (response != null) {
                    ...
                    for (let i = 11; i >= 0; i--) {
                        ...
                        if ($(idCampoMesAno).text() === stringMesAno) {
                            ...
                            $(idCampoFatInterno).text('R$ ' + response[index].valor_faturamento);
